...
define build.name = "ChooseYourOwnAdventureDorianGrayEdition"
...
define config.window_hide_transition = Dissolve(.75)
...
define config.save_directory = "ChooseYourOwnAdventureDorianGrayEdition-1573255662"
